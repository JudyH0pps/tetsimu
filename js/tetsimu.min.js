  ...
  var ConfigPanel = React.createClass({displayName: "ConfigPanel",
    ...
    render: function() {
      var simuKeyConfigItems = this._makeKeyConfigItems([
        ...
        { actionName: '돌아가기', action: 'backToEditMode'},
      ...
      var replayKeyConfigItems = this._makeKeyConfigItems([
        ...
        { actionName: '처음부터', action: 'backToHead'},
      ...
      var editKeyConfigItems = this._makeKeyConfigItems([
        { actionName: 'I 미노', action: 'selectTypeI'},
        { actionName: 'J 미노', action: 'selectTypeJ'},
        { actionName: 'L 미노', action: 'selectTypeL'},
        { actionName: 'O 미노', action: 'selectTypeO'},
        { actionName: 'S 미노', action: 'selectTypeS'},
        { actionName: 'T 미노', action: 'selectTypeT'},
        { actionName: 'Z 미노', action: 'selectTypeZ'},
        { actionName: '방해 블록', action: 'selectTypeOjama'},
        { actionName: '빈 칸', action: 'selectTypeNone'},
      ...
      return React.createElement("div", {className: "config-panel"}, 
          React.createElement("div", {className: "inner-config-panel"}, 
            ...
            React.createElement("div", {className: "config-button-area"}, 
              ...
              React.createElement("button", {onClick: this.onInitialize}, "초기설정으로 돌아가기")
            )
          ), 
      ...
      return React.createElement("div", {className: "operation-panel"}, 
          ...
          React.createElement("div", {className: "operation-mode-panel"}, 
            React.createElement("div", {className: "operation-simu-panel"}, 
              ...
              (!!this.state.before) ?
                React.createElement("a", {className: "operation-btn", href: "javascript:void(0)", onClick: this.onCancel}, "돌아가기")
                : "", 
      ...
      return React.createElement("div", {className: "operation-panel"}, 
          ...
          React.createElement("div", {className: "operation-mode-panel"}, 
            React.createElement("div", {className: "operation-simu-panel"}, 
              ...
              (!!this.state.before) ?
                React.createElement("a", {className: "operation-btn", href: "javascript:void(0)", onClick: this.onBackToEditMode}, "돌아가기")
                : "", 
